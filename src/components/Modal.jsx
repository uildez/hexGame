...
export const Modal = () => {
    const { openModal, setOpenModal, options, selected, setSelected } =
        useContext(Context);
                        ...
                        <div className="rounded-lg shadow bg-slate-600 max-w-[600px] p-4">
                            ...
                            <div className="px-4 py-2">
                                <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                    The game consists of hitting as many colors
                                    as possible in 30s. When the game starts, a
                                    random color will appear and stop 3 answer
                                    options should appear (must be in
                                    hexadecimal). Two of which are incorrect
                                    (randomly generated), and a correct one.
                                    Each round, a new color appears, and the
                                    player will have 10s to respond and result
                                    in win or loss of score:
                                </p>
                                <ul className="ml-6 mt-4 list-disc text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                    ...
                                    <li>
                                        If the player answers in time but wrong,
                                        he will lose 1 point.{" "}
                                    </li>
                                    <li>
                                        If the player answers in time and
                                        correctly, he will earn 5 spots.
                                    </li>
                                </ul>
                            </div>
